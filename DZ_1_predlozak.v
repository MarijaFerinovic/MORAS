...
Lemma NotL_repeat : forall (n : nat), NotL (repeat O n) = repeat I n.
Proof.
  intros n. 
  induction n as [| a IHa]. 
  - simpl. reflexivity.
  - simpl. f_equal. apply IHa. 
Qed.

Lemma AddL_repeat_zero : forall n : nat, AddL (repeat I n) (repeat I n) = repeat O n.
Proof.
Proof.
  intros n.
  unfold AddL. simpl. induction n as [| n' IH].
 - simpl. reflexivity.
Admitted.



Lemma NotL_repeat_O : forall n : nat, NotL (repeat O n) = repeat O n.
Proof.
  intros n.
...
Lemma repeat_O_n : forall n : nat, repeat O n = repeat O (Nat.pred n) ++ [I].
Proof.
  intros n.
  destruct n as [|n'].
  -simpl.
...
Proof.
  ...
  simpl.
  symmetry in A, B.
  destruct A, B. rewrite NotL_repeat. simpl. rewrite AddL_repeat_zero. simpl. rewrite NotL_repeat_O. rewrite repeat_O_n. simpl. 
reflexivity.
Qed.
